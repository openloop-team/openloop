...
def test_default_is_host_sandbox():
    sandbox = appmod.build_worker_sandbox(Settings())
...
def test_docker_sandbox_built_when_probe_passes(monkeypatch):
    ...
    sandbox = appmod.build_worker_sandbox(
        Settings(
